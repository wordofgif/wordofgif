...
~~~sh
# getting the code
git clone git@github.com:nko4/witty-wizards.git && cd ./witty-wizards/

# developing
npm install
npm start

# deploying (to http://witty-wizards.2013.nodeknockout.com/)
./deploy nko

# ssh access
ssh deploy@witty-wizards.2013.nodeknockout.com
ssh root@witty-wizards.2013.nodeknockout.com
# or, if you get prompted for a password
ssh -i ./id_deploy deploy@witty-wizards.2013.nodeknockout.com
ssh -i ./id_deploy root@witty-wizards.2013.nodeknockout.com
~~~
...
~~~html
<iframe src="http://nodeknockout.com/iframe/witty-wizards" frameborder=0 scrolling=no allowtransparency=true width=115 height=25>
</iframe>
~~~
